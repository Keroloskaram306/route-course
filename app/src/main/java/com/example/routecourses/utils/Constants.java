package com.example.routecourses.utils;

public interface Constants {
    String COURSE="course";
    String ANDROID_COURSE="andriod";
    String Ios_COURSE ="ios";
    String fullStack_Course="fullstack";
    String ANDROID_DETALS = "1. Introduction to Java Programming\n" +
            "• Overview.\n" +
            "• Compiler and JVM\n" +
            "• Project Structure\n" +
            ...
            String FULLSTACK_DETAILS="•HTML\t\n" +
                    ...
                    String IOS_DETALS="OOP refreshment\n" +
                            "• Introduction\n" +
